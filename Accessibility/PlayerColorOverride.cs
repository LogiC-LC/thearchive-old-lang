...
namespace TheArchive.Features.Accessibility
{
    ...
    public class PlayerColorOverride : Feature
    {
        ...
        public class PlayerColorOverrideSettings
        {
            ...
            [FSDescription("使用远程玩家的自定义（有颜色的）昵称作为玩家的颜色。\n\n<color=orange>警告！这会覆盖上述设置，如果远程玩家有彩色昵称！</color>",Language.Chinese)]
            public bool RemoteUseNicknameColorAsPlayerColor { get; set; } = true;

            [FSDisplayName("Only fully colored names")]
            [FSDisplayName("仅完全彩色名称",Language.Chinese)]
            ...
            [FSDescription("只有整个名称都有颜色时才选择昵称颜色。\n\n示例：\n<#404>昵称</color> -> <#0c0>作为玩家颜色</color>\n<#404>尼</color>克名 -> <#c00>不作为玩家颜色</color>",Language.Chinese)]

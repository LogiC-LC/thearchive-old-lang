...
namespace TheArchive.Features.Hud
{
    ...
    public class ExpeditionResultsScreenTweaks : Feature
    {
        ...
        public class ExpeditionResultsScreenTweaksSettings
        {
            ...
            [FSDisplayName("添加失败远征计时器", Language.Chinese)]
